...
// node_modules/react-github-user-stats/dist/index.es.js
...
var getUserTotalStars = function(username, per_page) {
  ...
  return new Promise(function(resolve, reject) {
    fetch(GITHUB_URI + "/" + username + "/repos?per_page=" + per_page).then(function(response) {
...
var getUserProfileData = function(username) {
  return new Promise(function(resolve, reject) {
    fetch(GITHUB_URI + "/" + username).then(function(response) {
      response.json().then(function(data) {
        resolve(data);
      });
    }).catch(reject);
...
function useGithubStats(username, per_page) {
  ...
  var _a = (0, import_react.useState)(false), loading = _a[0], setLoading = _a[1];
  var _b = (0, import_react.useState)(""), error = _b[0], setError = _b[1];
  var _c = (0, import_react.useState)(null), userData = _c[0], setUserData = _c[1];
    ...
    return __awaiter(_this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a2) {
        switch (_a2.label) {
          ...
          case 1:
            _a2.trys.push([1, 5, , 6]);
            return [4, getUserProfileData(username)];
          case 2:
            data = _a2.sent();
            return [4, getUserTotalStars(username, per_page)];
          case 3:
            stars = _a2.sent();
            return [4, getUserTotalForks(username, per_page)];
          case 4:
            forks = _a2.sent();
            setUserData({
...
// dep:react-github-user-stats
var react_github_user_stats_default = useGithubStats;
export {
  react_github_user_stats_default as default
};
//# sourceMappingURL=react-github-user-stats.js.map
